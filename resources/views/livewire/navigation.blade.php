                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        @foreach ($categories as $category)
                            <a href="{{route('posts.category', $category)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-bold">{{$category->name}}</a>
                        @endforeach
                ...
                <div class="relative ml-3" x-data="{ open: false }">
                    ...
                    <div x-show="open" x-on:click.away = "open=false"
                        ...
                        <form method="POST" action="{{ route('logout') }}" x-data>
                            @csrf
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2" @click.prevent="$root.submit();">Cerrar Sesion</a>
                        </form>
                    </div>
                </div>
            </div>
